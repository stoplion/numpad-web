        ...
        if (line) {
            try {
                ...
                if (settings.lineErrors) {
                    lineNo = '<span class="lineError">' + lineNo + '</span>';
                    answer = '<a title=' + errStr + ' class="lineError" onClick="showError(&apos;' + errStr + '&apos;);">err</a>';
                }
            }
        }
        answers.push(answer);
